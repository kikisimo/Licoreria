            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="index2.html"><i class="fa fa-circle-o"></i> Borrar Productos</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-circle-o"></i> Registrar Nuevo Venta</a></li>
...
<form action= "altas.php" method="post">
    ...
    <table width="314" border="0" align="center">
        <tr>
            <td width="163">Cod_prod:</td>
            <td width="156"><input type="text" name="cod_prod" id="cod_prod" required></td>
        </tr>
        <tr>
            <td>Tipo:</td>
        ...
        <tr>
            ...
            <td><input type="text" name="preciou" id="preciou"></td>
        </tr>
        <tr>
            <td>Cod_prov:</td>
